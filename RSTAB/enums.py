...
class GlobalParameterUnitGroup(Enum):
    ...
    RATIO, RELATIVE_LENGTH, CROSS_SECTION_ANGLE, CROSS_SECTION_AREA, CROSS_SECTION_BIMOMENT, CROSS_SECTION_COMPLIANCE, CROSS_SECTION_DIMENSION, \
    CROSS_SECTION_EFFECTIVE_SECOND_MOMENT_OF_AREA, CROSS_SECTION_FORCE, CROSS_SECTION_MOMENT, CROSS_SECTION_MOMENT_OF_INERTIA, \
    CROSS_SECTION_NORMALIZED_WARPING_CONSTANT, CROSS_SECTION_PERIMETER, CROSS_SECTION_QUANTITY, SECTION_SECTION_FACTOR, SECTION_SECTION_MODULUS, \
    CROSS_SECTION_STATICAL_MOMENT_OF_AREA, CROSS_SECTION_TENSION_FIELD_COEFFICIENT_1, CROSS_SECTION_TENSION_FIELD_COEFFICIENT_2, \
    CROSS_SECTION_UNIT_STRESSES, CROSS_SECTION_UNIT_WARPING_FUNCTION, CROSS_SECTION_WARPING_CONSTANT, CROSS_SECTION_WARPING_STATICAL_MOMENT, \
...
class ObjectTypes(Enum):
    ...
    E_OBJECT_TYPE_ALUMINUM_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, E_OBJECT_TYPE_ALUMINUM_MEMBER_TRANSVERSE_WELD, E_OBJECT_TYPE_CALCULATION_DIAGRAM, E_OBJECT_TYPE_CLIPPING_BOX, E_OBJECT_TYPE_CLIPPING_PLANE, E_OBJECT_TYPE_COMBINATION_WIZARD, \
    ...
    E_OBJECT_TYPE_RESPONSE_SPECTRUM, E_OBJECT_TYPE_RESULT_COMBINATION, E_OBJECT_TYPE_CROSS_SECTION, E_OBJECT_TYPE_SPECTRAL_ANALYSIS_SETTINGS, E_OBJECT_TYPE_STABILITY_ANALYSIS_SETTINGS, E_OBJECT_TYPE_STATIC_ANALYSIS_SETTINGS, \
    ...
    E_OBJECT_TYPE_STEEL_EFFECTIVE_LENGTHS, E_OBJECT_TYPE_STEEL_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, E_OBJECT_TYPE_STRUCTURE_MODIFICATION, E_OBJECT_TYPE_TERRAIN, E_OBJECT_TYPE_TIMBER_DESIGN_FR_CONFIGURATION, \
    E_OBJECT_TYPE_TIMBER_DESIGN_SLS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_DESIGN_ULS_CONFIGURATION, E_OBJECT_TYPE_TIMBER_EFFECTIVE_LENGTHS, E_OBJECT_TYPE_TIMBER_MEMBER_LOCAL_CROSS_SECTION_REDUCTION, E_OBJECT_TYPE_TIMBER_MOISTURE_CLASS, \
...
class MemberImperfectionSectionDesign(Enum):
    ...
    '''
    CROSS_SECTION_DESIGN_ELASTIC, CROSS_SECTION_DESIGN_PLASTIC = range(2)
...
class NodalSupportNonlinearity(Enum):
    ...
    '''
    NONLINEARITY_TYPE_DIAGRAM, NONLINEARITY_TYPE_FAILURE_ALL_IF_NEGATIVE, NONLINEARITY_TYPE_FAILURE_ALL_IF_POSITIVE, NONLINEARITY_TYPE_FAILURE_IF_NEGATIVE, NONLINEARITY_TYPE_FAILURE_IF_POSITIVE, \
    NONLINEARITY_TYPE_FORCE_MOMENT_DIAGRAM, NONLINEARITY_TYPE_FRICTION_DIRECTION_1, NONLINEARITY_TYPE_FRICTION_DIRECTION_1_2, NONLINEARITY_TYPE_FRICTION_DIRECTION_1_PLUS_2, \
    NONLINEARITY_TYPE_FRICTION_DIRECTION_2, NONLINEARITY_TYPE_NONE, NONLINEARITY_TYPE_PARTIAL_ACTIVITY, NONLINEARITY_TYPE_STIFFNESS_DIAGRAM = range(13)

class NodalSupportDiagramType(Enum):
    '''
