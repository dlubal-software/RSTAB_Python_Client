...
from RSTAB.enums import AddOn, TimberServiceConditionsMoistureType
...
def test_timberServiceConditionsGB():
    ...
    openFile(os.path.join(dirname, 'src', 'timberServiceConditionGB.rs9'))
    ...
    closeModel('timberServiceConditionGB.rs9')
