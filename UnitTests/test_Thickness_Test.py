...
from RSTAB.enums import ThicknessDirection, ThicknessOrthotropyType
from RSTAB.enums import ThicknessShapeOrthotropySelfWeightDefinitionType, ThicknessStiffnessMatrixSelfWeightDefinitionType
