...
class GlobalParameter():
    ...
    @staticmethod
    def SetFormula(ObjectType = ObjectTypes.E_OBJECT_TYPE_ACTION,
                   no: int = 1,
                   parent_no: int = 1,
    ...
    @staticmethod
    def GetFormula(ObjectType = ObjectTypes.E_OBJECT_TYPE_NODAL_LOAD,
                   no: int = 1,
                   parent_no: int = 1,
                   attribute: str = 'magnitude',
                   model = Model):
        ...
        Args:
            ObjectType (enum): Enumeration of object type e.g. ObjectTypes.E_OBJECT_TYPE_NODAL_LOAD
            no (int): ID of object
            parent_no (int): Id of parent of object - e.g. Id of load case for loads
    ...
    @staticmethod
    def IsFormulaAllowed(ObjectType = ObjectTypes.E_OBJECT_TYPE_NODAL_LOAD,
                         no: int = 1,
                         parent_no: int = 1,
                         attribute: str = 'magnitude',
                         model = Model):
