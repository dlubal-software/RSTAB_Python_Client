...
from RSTAB.enums import AddOn, TimberServiceConditionsMoistureType, TimberServiceConditionsTreatmentType
...
def test_timberServiceConditionsCSA():
    ...
    openFile(os.path.join(dirname, 'src', 'timberServiceConditionCSA.rs9'))
    ...
    closeModel('timberServiceConditionCSA.rs9')
