...
from RSTAB.TypesForMembers.memberResultIntermediatePoints import MemberResultIntermediatePoint
...
def test_memberDefinableStiffness():
    ...
    MemberDefinableStiffness(1, '', '', 1, 2, 4, 5, 6, 7, 8, 9, 10, 11, 12)
...
def test_memberHinge():
    ...
    MemberHinge(3, "Local", "", translational_release_vy=0, translational_release_vy_nonlinearity=[MemberHingeNonlinearity.NONLINEARITY_TYPE_DIAGRAM, [True, MemberHingeDiagramType.DIAGRAM_ENDING_TYPE_CONTINUOUS], [[1,2, 3], [3,4, 5]]])
    MemberHinge(4, "Local", "", translational_release_vz=0, translational_release_vz_nonlinearity=[MemberHingeNonlinearity.NONLINEARITY_TYPE_PARTIAL_ACTIVITY, [MemberHingePartialActivityType.PARTIAL_ACTIVITY_TYPE_FIXED, 0.004, 0.04], [MemberHingePartialActivityType.PARTIAL_ACTIVITY_TYPE_FIXED, 0.005, 0.05]])
