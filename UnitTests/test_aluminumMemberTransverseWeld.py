...
from RSTAB.enums import AddOn, WeldComponentType
from RSTAB.initModel import Model, SetAddonStatus
from RSTAB.TypesForAluminumDesign. aluminumMemberTransverseWelds import AluminumMemberTransverseWeld, transverseWeldComponent
import pytest
...
#@pytest.mark.skipif(CheckIfMethodOrTypeExists(Model.clientModel,'ns0:aluminum_member_transverse_weld', True), reason="Type ns0:aluminum_member_transverse_weld not in RSTAB GM yet")
