...
import pytest
from RSTAB.initModel import insertSpaces
...
#@pytest.mark.skipif(CheckIfMethodOrTypeExists(Model.clientModel,'set_model_settings_and_options', True), reason="set_model_settings_and_options not in RSTAB yet")
...
# Write sepatate test when used method/type is not in RSTAB yet, to be able to skip it for example.
