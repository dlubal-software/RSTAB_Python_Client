...
def test_AluminumMemberLocalSectionReduction():
    ...
    smlr_1 = Model.clientModel.service.get_aluminum_member_local_cross_section_reduction(1)
    ...
    smlr_2 = Model.clientModel.service.get_aluminum_member_local_cross_section_reduction(2)
    ...
    smlr_3 = Model.clientModel.service.get_aluminum_member_local_cross_section_reduction(3)
