...
def test_AddOns():
    ...
    #SetAddonStatus(Model.clientModel, AddOn.timber_joints_active, True)                :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #SetAddonStatus(Model.clientModel, AddOn.craneway_design_active, True)              :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    ...
    #SetAddonStatus(Model.clientModel, AddOn.cutting_patterns_active, True)             :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    ...
    #SetAddonStatus(Model.clientModel, AddOn.time_history_active, True)                 :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #SetAddonStatus(Model.clientModel, AddOn.pushover_active, True)                     :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #SetAddonStatus(Model.clientModel, AddOn.harmonic_response_active, True)            :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #SetAddonStatus(Model.clientModel, AddOn.wind_simulation_active, True)              :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    ...
    #assert GetAddonStatus(Model.clientModel, AddOn.timber_joints_active)               :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #assert GetAddonStatus(Model.clientModel, AddOn.craneway_design_active)             :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    ...
    #assert GetAddonStatus(Model.clientModel, AddOn.cutting_patterns_active)            :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    ...
    #assert GetAddonStatus(Model.clientModel, AddOn.time_history_active)                :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #assert GetAddonStatus(Model.clientModel, AddOn.pushover_active)                    :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #assert GetAddonStatus(Model.clientModel, AddOn.harmonic_response_active)           :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
    #assert GetAddonStatus(Model.clientModel, AddOn.wind_simulation_active)             :   Add-Ons greyed out in RSTAB GUI. Assumedly still WIP
