...
from RSTAB.initModel import Model, SetAddonStatus, CheckIfMethodOrTypeExists, AddOn
from RSTAB.TypesForSteelDesign.steelMemberShearPanel import SteelMemberShearPanel

if Model.clientModel is None:
    Model()

@pytest.mark.skipif(CheckIfMethodOrTypeExists(Model.clientModel,'ns0:steel_member_shear_panel', True), reason="Type ns0:steel_member_shear_panel not in RSTAB GM yet")
def test_steelMemberShearPanel():
    ...
    SteelMemberShearPanel(2, "shearPanel", SteelMemberShearPanelDefinitionType.DEFINITION_TYPE_TRAPEZOIDAL_SHEETING, "1", "",
    ...
    SteelMemberShearPanel(3, "", SteelMemberShearPanelDefinitionType.DEFINITION_TYPE_BRACING, "", "",
