...
from RSTAB.enums import AddOn, SteelMemberRotationalRestraintType
...
class SteelMemberRotationalRestraint():
    def __init__(self,
        ...
        if modelInfo.property_addon_steel_design.split()[0] != 'Steel':
            raise ValueError("WARNING: The steelMemberRotationalRestraints operates with the RSTAB Application set to English. Kindly switch RSTAB to English such that Database searches can completed successfully.")
