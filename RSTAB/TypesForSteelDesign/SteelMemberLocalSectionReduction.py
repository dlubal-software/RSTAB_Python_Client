...
from RSTAB.enums import SteelMemberLocalCrossSectionReductionType, MultipleOffsetDefinitionType, FastenerDefinitionType
...
class SteelMemberLocalCrossSectionReduction():
    ...
    def __init__(self,
        ...
        clientObject = model.clientModel.factory.create('ns0:steel_member_local_cross_section_reduction')
        ...
        clientObject.components = model.clientModel.factory.create('ns0:array_of_steel_member_local_cross_section_reduction_components')

        for i,j in enumerate(components):
            smlsr = model.clientModel.factory.create('ns0:steel_member_local_cross_section_reduction_components_row')
            smlsr.no = i+1
            smlsr.row = model.clientModel.factory.create('ns0:steel_member_local_cross_section_reduction_components')
            ...
            clientObject.components.steel_member_local_cross_section_reduction_components.append(smlsr)
        ...
        model.clientModel.service.set_steel_member_local_cross_section_reduction(clientObject)
